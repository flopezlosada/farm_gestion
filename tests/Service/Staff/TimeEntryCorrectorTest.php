...
{
    private function corrector(): TimeEntryCorrector
    {
        $em = $this->createMock(EntityManagerInterface::class);

        return new TimeEntryCorrector($em, new MockClock(new \DateTimeImmutable('2026-06-20 10:00:00', new \DateTimeZone('UTC'))));
    }
    ...
    public function testCorregirHoraAnulaElOriginalYCreaUnoNuevo(): void
    {
        ...
        $new = $this->corrector()->correctTime(
            $original,
