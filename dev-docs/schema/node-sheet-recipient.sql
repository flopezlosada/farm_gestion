...
CREATE TABLE node_sheet_recipient (
    ...
    INDEX IDX_node_sheet_recipient_user (user_id),
    PRIMARY KEY(node_id, user_id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;

-- ON DELETE CASCADE en los dos lados: si se borra un nodo o una cuenta, la fila
-- deja de tener sentido. Perder un destinatario es inocuo (el listado cae al
-- ajuste general); dejar una fila huérfana rompería la carga de la relación.
...
ALTER TABLE node_sheet_recipient
    ADD CONSTRAINT FK_node_sheet_recipient_user FOREIGN KEY (user_id) REFERENCES fos_user (id) ON DELETE CASCADE;
