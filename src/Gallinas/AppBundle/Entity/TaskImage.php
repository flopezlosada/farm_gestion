...
/**
 * Gallinas\AppBundle\Entity\TaskImage
 * @ORM\Table(name="task_image")
 * @ORM\Entity(repositoryClass="Gallinas\AppBundle\Entity\TaskImageRepository")
...
class TaskImage
{
    ...
    /** @ORM\ManyToOne(targetEntity="Task", inversedBy="images")
     ...
     * @return TaskImage
     */
    public function setTask(\Gallinas\AppBundle\Entity\Task $task = null)
    {
        $this->task = $task;
     ...
     * Get task
     *
     * @return \Gallinas\AppBundle\Entity\Task
     */
