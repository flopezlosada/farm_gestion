...
class SeedWorkEntity extends CalendarEventEntity
{
    protected $bgColor = '#aa7700';
    //protected $cssClass = 'seedwork_event';
    ...
    {
        $this->url = $router->generate("seedwork_show", array('id' => $this->getId()));
    }
