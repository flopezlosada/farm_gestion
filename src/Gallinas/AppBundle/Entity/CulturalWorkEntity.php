...
class CulturalWorkEntity extends CalendarEventEntity
{
    protected $bgColor = '#770088';
    //protected $cssClass = 'culturalwork_event';
    ...
    {
        $this->url = $router->generate("culturalwork_show", array('id' => $this->getId()));
    }
