...
use Gallinas\AppBundle\Entity\Provider;
use Gallinas\AppBundle\Form\ProviderType;
...
class ProviderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Provider')->findAll();

        return $this->render('AppBundle:Provider:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppBundle:Provider:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('AppBundle:Provider:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppBundle:Provider:edit.html.twig', array(
            'entity'      => $entity,
