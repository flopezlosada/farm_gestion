...
use Gallinas\AppBundle\Entity\Gallery;
use Gallinas\AppBundle\Form\GalleryType;
...
class GalleryController extends Controller
{
    ...
    public function show_snippetAction($id,$object_class)
    {
        $em = $this->getDoctrine()->getManager();
        ...
        $images = $em->getRepository('AppBundle:Image')->findBlogGroupedImages($id,$object_class);
