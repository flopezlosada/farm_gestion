...
use Gallinas\AppBundle\Entity\Note;
use Gallinas\AppBundle\Form\NoteType;
...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Note')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppBundle:Note:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('AppBundle:Note:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppBundle:Note:edit.html.twig', array(
            'entity'      => $entity,
