...
use Gallinas\AppBundle\Entity\FowlDestination;
use Gallinas\AppBundle\Form\FowlDestinationType;

/**
 * FowlDestination controller.
 *
 */
class FowlDestinationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:FowlDestination')->findAll();

        return $this->render('AppBundle:FowlDestination:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppBundle:FowlDestination:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(new FowlDestinationType(), $entity, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:FowlDestination')->find($id);
        ...
        return $this->render('AppBundle:FowlDestination:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppBundle:FowlDestination:edit.html.twig', array(
            'entity'      => $entity,
