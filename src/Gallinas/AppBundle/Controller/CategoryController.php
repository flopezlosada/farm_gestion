...
use Gallinas\AppBundle\Entity\Category;
use Gallinas\AppBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    */
    ...
    public function list_asideAction()
    {
          $em = $this->getDoctrine()->getManager();
        $entities=$em->getRepository("AppBundle:Category")->findAll();

        return $this->render("AppBundle:Category:list_aside.html.twig", array(
            'entities'=>$entities,
        ));
    }
}
