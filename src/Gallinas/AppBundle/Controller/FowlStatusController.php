...
use Gallinas\AppBundle\Entity\FowlStatus;
use Gallinas\AppBundle\Form\FowlStatusType;

/**
 * FowlStatus controller.
 *
 */
class FowlStatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:FowlStatus')->findAll();

        return $this->render('AppBundle:FowlStatus:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppBundle:FowlStatus:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(new FowlStatusType(), $entity, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:FowlStatus')->find($id);
        ...
        return $this->render('AppBundle:FowlStatus:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppBundle:FowlStatus:edit.html.twig', array(
            'entity'      => $entity,
