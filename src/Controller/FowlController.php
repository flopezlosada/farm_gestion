...
class FowlController extends AbstractAppController
{
    ...
    public function create(Request $request)
    {
        ...
        return $this->render('Fowl/new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(FowlType::class, $entity, array(
    ...
    public function show($id)
    {
        ...
        return $this->render('Fowl/show.html.twig', array(
            'entity' => $entity,
    ...
    public function edit($id)
    {
        ...
        return $this->render('Fowl/edit.html.twig', array(
            'entity' => $entity,
