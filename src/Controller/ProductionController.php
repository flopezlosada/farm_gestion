...
class ProductionController extends AbstractController
{
    ...
    public function create(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $entity->setCrop($entity->getCropWorking()->getCrop());
    ...
    {
        $form = $this->createForm(ProductionType::class, $entity, array(
    ...
    public function basketDetail($id)
    {
        ...
        return $this->render('Production/basket_detail.html.twig', array(
            'basket' => $basket,
