 ...
 *
 */
class VarietyController extends AbstractAppController
{
    ...
    public function create(Request $request)
    {
        ...
        return $this->render('Variety/new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(VarietyType::class, $entity, array(
    ...
    public function show($id)
    {
        ...
        return $this->render('Variety/show.html.twig', array(
            'entity' => $entity,
    ...
    public function edit($id)
    {
        ...
        return $this->render('Variety/edit.html.twig', array(
            'entity' => $entity,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('variety_show', array('id' => $id)));
        }
