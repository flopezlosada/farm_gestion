...
class CulturalWorkTypeController extends AbstractAppController
{
    ...
    public function create(Request $request)
    {
        ...
        return $this->render('CulturalWorkType/new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(CulturalWorkTypeType::class, $entity, array(
    ...
    public function show($id)
    {
        ...
        return $this->render('CulturalWorkType/show.html.twig', array(
            'entity' => $entity,
