...
class Sale
{
    ...
    /**
     * @var smallint $unity
     * @ORM\ManyToOne(targetEntity="App\Entity\Unity", inversedBy="sales")
     */
    #[Assert\NotBlank]
    private $unity;
     ...
     * @ORM\ManyToOne(targetEntity="App\Entity\Purchaser", inversedBy="purchases")
     */
    #[Assert\NotBlank]
    private $purchaser;
     ...
     * Set purchaser
     *
     * @param \App\Entity\Purchaser $purchaser
     * @return Sale
     */
    public function setPurchaser(\App\Entity\Purchaser $purchaser = null)
    {
