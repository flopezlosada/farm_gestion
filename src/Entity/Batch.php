...
class Batch
{
     ...
     * Set batch_status
     *
     * @param \App\Entity\BatchStatus $batchStatus
     * @return Batch
     */
    public function setBatchStatus(\App\Entity\BatchStatus $batchStatus = null)
    {
     ...
     * Add lay
     *
     * @param \App\Entity\Lay $lay
     *
     * @return Batch
     */
    public function addLay(\App\Entity\Lay $lay)
    {
        $this->lays[] = $lay;
     ...
     * @param \App\Entity\Lay $lay
     */
    public function removeLay(\App\Entity\Lay $lay)
    {
