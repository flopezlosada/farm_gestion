...
class Basket
{
    ...
    /**
     * Controla el listado semanal de cestas que ha ido teniendo. Cada semana aparece 1 registro
     * @ORM\OneToMany(targetEntity="WeeklyBasket", mappedBy="basket")
     *
     */
    ...
    public function removeWeeklyBasket(WeeklyBasket $weeklyBasket): self
    {
        if ($this->weekly_baskets->contains($weeklyBasket)) {
            ...
            if ($weeklyBasket->getBasket() === $this) {
                $weeklyBasket->setBasket(null);
            }
        }
