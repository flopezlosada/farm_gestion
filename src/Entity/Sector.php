...
class Sector
{
    ...
    public function __construct()
    {
        ...
        $this->cultural_works = new ArrayCollection();
        $this->seed_works = new ArrayCollection();
     ...
     * Add crop_workings
     *
     * @param \App\Entity\CropWorking $cropWorkings
     * @return Sector
     */
    public function addCropWorking(\App\Entity\CropWorking $cropWorkings)
    {
     ...
     * @param \App\Entity\CropWorking $cropWorkings
     */
    public function removeCropWorking(\App\Entity\CropWorking $cropWorkings)
    {
     ...
     * Add movements
     *
     * @param \App\Entity\Movement $movements
     * @return Sector
     */
    public function addMovement(\App\Entity\Movement $movements)
    {
     ...
     * @param \App\Entity\Movement $movements
     */
    public function removeMovement(\App\Entity\Movement $movements)
    {
