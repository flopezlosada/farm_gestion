...
/**
 * App\Entity\Purchaser
 *
 * @ORM\Table(name="purchaser")
 * @ORM\Entity(repositoryClass="App\Repository\PurchaserRepository")
 */
class Purchaser
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Sale", mappedBy="purchaser")
     */
    protected $purchases;
     ...
     * Add purchases
     *
     * @param \App\Entity\Sale $purchases
     * @return Purchaser
     */
    public function addPurchase(\App\Entity\Sale $purchases)
    {
     ...
     * @param \App\Entity\Sale $purchases
     */
    public function removePurchase(\App\Entity\Sale $purchases)
    {
