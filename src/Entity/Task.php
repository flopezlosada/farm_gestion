...
class Task
{
     ...
     * Set labour
     *
     * @param \App\Entity\Labour $labour
     *
     * @return Task
     */
    public function setLabour(\App\Entity\Labour $labour = null)
    {
        $this->labour = $labour;
     ...
     * Set taskType
     *
     * @param \App\Entity\TaskType $taskType
     *
     * @return Task
     */
    public function setTaskType(\App\Entity\TaskType $taskType = null)
    {
     ...
     * Add note
     *
     * @param \App\Entity\TaskNote $note
     *
     * @return Task
     */
    public function addNote(\App\Entity\TaskNote $note)
    {
        $this->notes[] = $note;
     ...
     * @param \App\Entity\TaskNote $note
     */
    public function removeNote(\App\Entity\TaskNote $note)
    {
     ...
     * Add image
     *
     * @param \App\Entity\TaskImage $image
     *
     * @return Task
     */
    public function addImage(\App\Entity\TaskImage $image)
    {
        $this->images[] = $image;
     ...
     * @param \App\Entity\TaskImage $image
     */
    public function removeImage(\App\Entity\TaskImage $image)
    {
