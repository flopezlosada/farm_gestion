...
/**
 * App\Entity\CropWorking
 *
 * @ORM\Table(name="crop_working")
 * @ORM\Entity(repositoryClass="App\Repository\CropWorkingRepository")
 */
class CropWorking
{
    /**
     ...
     * @ORM\ManyToMany(targetEntity="Task", mappedBy="crop_workings")
     ...
     * Add productions
     *
     * @param \App\Entity\Production $productions
     * @return CropWorking
     */
    public function addProduction(\App\Entity\Production $productions)
    {
     ...
     * @param \App\Entity\Production $productions
     */
    public function removeProduction(\App\Entity\Production $productions)
    {
     ...
     * Add cultural_works
     *
     * @param \App\Entity\CulturalWork $culturalWorks
     * @return CropWorking
     */
    public function addCulturalWork(\App\Entity\CulturalWork $culturalWorks)
    {
     ...
     * @param \App\Entity\CulturalWork $culturalWorks
     */
    public function removeCulturalWork(\App\Entity\CulturalWork $culturalWorks)
    {
     ...
     * Add seed_works
     *
     * @param \App\Entity\SeedWork $seedWorks
     * @return CropWorking
     */
    public function addSeedWork(\App\Entity\SeedWork $seedWorks)
    {
     ...
     * @param \App\Entity\SeedWork $seedWorks
     */
    public function removeSeedWork(\App\Entity\SeedWork $seedWorks)
    {
     ...
     * Add sectors
     *
     * @param \App\Entity\Sector $sectors
     * @return CropWorking
     */
    public function addSector(\App\Entity\Sector $sectors)
    {
     ...
     * @param \App\Entity\Sector $sectors
     */
    public function removeSector(\App\Entity\Sector $sectors)
    {
