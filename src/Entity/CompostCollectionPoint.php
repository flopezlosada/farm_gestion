...
/**
 * App\Entity\CompostCollectionPoint
 *
 * @ORM\Table(name="compost_collection_point")
 * @ORM\Entity(repositoryClass="App\Repository\CompostCollectionPointRepository")
 */
class CompostCollectionPoint
{
     ...
     *
     * @param \App\Entity\CompostCollection $compostCollections
     * @return CompostCollectionPoint
     */
    public function addCompostCollection(\App\Entity\CompostCollection $compostCollections)
    {
     ...
     * @param \App\Entity\CompostCollection $compostCollections
     */
    public function removeCompostCollection(\App\Entity\CompostCollection $compostCollections)
    {
