...
class TaskPeriodicType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('content',null, array('label'=>'Contenido', 'required'=>true))
            ->add('period',TextType::class, array('label'=>'Indica (en días) cada cuánto tiempo se repite la tarea'))
            ->add('expected_date',TextType::class, array('label'=>'Fecha de realización', 'attr'=>array('class'=>'datepicker form-control', 'required'=>true)))
