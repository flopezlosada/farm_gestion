 ...
 * generan. El congelado del listado semanal es exactamente ese caso
 * ({@see \App\Command\GenerateWeeklyDeliveryCommand}, la comprobación de "ya
 * listado"), y duplicarlo significaría dos cestas por socix en el reparto.
 *
